...
public class FriendsFragment extends Fragment {
    ...
    public void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Friends,FriendsViewHolder> friendsRecyclerViewAdapter = new FirebaseRecyclerAdapter<Friends, FriendsViewHolder>(Friends.class,R.layout.users_single_layout,FriendsViewHolder.class,mFriendDatabase) {
            @Override
                ...
                mUsersDatabase.child(list_user_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.hasChild("online")){
                            Object online = dataSnapshot.child("online").getValue();
                            String userOnline;
                            if(online.toString().equals("true"))
                            {
                                userOnline = "online";
                            }
                            else
                                userOnline = Long.toString((Long)dataSnapshot.child("online").getValue());
    ...
    public static class FriendsViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setUserImage(String thumb_image, Context ctx){
            ...
            Picasso.with(ctx).load(thumb_image).placeholder(R.mipmap.dp_image).into(userImageView);
        }
